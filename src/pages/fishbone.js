...
const Post = () => {
    ...
    return(
        <div className="root sm:blurred-bg min-h-screen bg-background-black" onClick={(e) => collapse(e.target)}>
            ...
            <DesktopHeader/>
            <h2 className="font-display mx-2 my-4 text-white text-center txt-shadow text-5xl">Fishbone</h2>
            <div className="flex flex-col items-center">
            <img src={fishbone} alt="" className="w-full shadow-lg rounded sm:max-w-md"/>
            <article className="sm:my-container mt-6">
            ...
            <p className="font-display m-6  text-xl text-white txt-shadow text-center">Appears On:</p>
            <Carousel className="max-w-md shadow-lg" showThumbs={false} swipeable={false} showIndicators={false} showStatus={false} interval={10000} infiniteLoop={true} autoPlay={true}>
                <div>
                <a href="/sovmech">
                    <img src={live} alt="" />
